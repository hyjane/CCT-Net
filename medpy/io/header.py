...
def copy_meta_data(hdr_to, hdr_from):
    r"""
    Copy image meta datas (voxel spacing and offset) from one header to another.
...
class Header:
    ...
    def __init__(self, spacing=None, offset=None, direction=None, sitkimage=None):
        ...
        # determin the image's ndim and default datas types
    ...
    def get_info_consistent(self, ndim):
        """
        Returns the main meta-datas information adapted to the supplied
