...
class Compose(BaseCompose):
    ...
    def __call__(self, *args, force_apply: bool = False, **data) -> typing.Dict[str, typing.Any]:
        if args:
            raise KeyError("You have to pass datas to augmentations as named arguments, for example: aug(image=image)")
...
class Sequential(BaseCompose):
    ...
    Note:
        ...
        chose sequence to input datas (see the `Example` section for an example definition of such pipeline).
